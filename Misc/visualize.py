...
def autocorr(samples,iter_num, trial_num, savefig = True):
    for i in range(samples.shape[1]):  
        ...
        ax.set_ylabel('Acorr')
        if savefig:
            fig.savefig('../data/results/T' + str(trial_num) +
